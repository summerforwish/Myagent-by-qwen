...
def init_agent_service():
    llm_cfg = {'model': 'qwen2-1.5b-instruct', 'model_server': 'dashscope', 'api_key': 'sk-e961ef6648bd46b0be24b92f3855febe'}
...
def test(query='越秀区天气', file: Optional[str] = os.path.join(ROOT_RESOURCE, 'poem.pdf')):
    # Define the agent
